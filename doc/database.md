...
Categorises the different types of images used for benchmarking.
  ...
  * **name** - TEXT. The unique identifier for a type of Docker image. An
...
Nucleotides makes use of many files as part of the benchmarking process, this
includes input data files, reference files for comparison, result files
generated by Docker images, and log files. The file database tables are used to
describe and track these:

### file_type

Groups the different types of files used and generated during benchmarking by
their name and description.

  * **name** - VARCHAR. The string name is used to identify this file type
    e.g. "contig_fasta".

  * **description** - VARCHAR. Longer text description of the file type, e.g.
    "Reads assembled into larger contiguous sequences in FASTA format"

## file_instance

Table used to track the locations of files used as part of nucleotides:

  * **sha256** - VARCHAR. Sha256 digest of the file before compression.

  * **url** - VARCHAR. URI describing where the file is located.

  * **file_type_id** - INT. Foreign key to the file_type table, used to
...
Enumeration of the possible different biological sources used in nucleotides.
  ...
  * **name** - VARCHAR. The string name is used to identify this source type,
    e.g. "microbe".
...
description.
  ...
  * **name** - VARCHAR. The string name is used to identify this biological
...
description.
  ...
  * **name** - VARCHAR. The string name is used to identify the data when
...
A materialised view which de-normalises the biological_source, input_data_file,
...
Maps the Docker image type to benchmark data type.
  ...
  * **name** - TEXT. The unique text identifier for the benchmark type. An
    example is "short_read_assembler".
