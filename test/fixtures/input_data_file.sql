...
VALUES ((SELECT id FROM input_data_file_set WHERE name   = 'regular_fragment_1' LIMIT 1),
        (SELECT id FROM file_instance       WHERE sha256 = '7673a')),
       ((SELECT id FROM input_data_file_set WHERE name   = 'regular_fragment_1' LIMIT 1),
